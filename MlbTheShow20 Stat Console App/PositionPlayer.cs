...
namespace Mlb20TheShow_Stat_Randomizer
{
	public class PositionPlayer
	{
		...
		{
			double total = ContactVsRight + ContactVsLeft + PowerVsRight + PowerVsLeft + Vision + Discipline + Clutch + Bunt + DragBunt + Durability + Fielding + ArmStrength +
			               ArmAccuracy + Reaction + Speed + Stealing + BaserunningAggressiveness;
			return total / 17;
		}
